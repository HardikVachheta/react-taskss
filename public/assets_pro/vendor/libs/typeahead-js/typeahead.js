                      ...
                      t = e.fn.typeahead, s = {
                         ...
                         initialize: function (t, o) {
                            ...
                            function g() {
                               ...
                               })), i = e(this), g = e(a.html.wrapper), m = p(t.hint), y = p(t.menu), v = !1 !== t.hint && !m, _ = !1 !== t.menu && !y, v && (m = f(i, a)), _ && (y = e(a.html.menu).css(a.css.menu)), m && m.val(""), i = d(i, a), (v || _) && (g.css(a.css.wrapper), i.css(v ? a.css.input : a.css.inputWithNoHint), i.wrap(g).parent().prepend(v ? m : null).append(_ ? y : null)), A = _ ? h : c, b = new r({
                                  el: i
                               }), w = new u({
                                  hint: m,
                                  input: i
