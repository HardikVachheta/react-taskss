                ...
                t.exports = function () {
                   ...
                   function m(t, e, r, i, n) {
                      ...
                      if (void 0 === i && (i = !0), void 0 === n && (n = !1), "top" === e) l = ["contentHeight", "containerHeight", "scrollTop", "y", "up", "down"];
                         ...
                         var u = t.element;
                         t.reach[a] = null, u[s] < 1 && (t.reach[a] = "start"), u[s] > t[l] - t[o] - 1 && (t.reach[a] = "end"), e && (u.dispatchEvent(v("ps-scroll-" + a)), e < 0 ? u.dispatchEvent(v("ps-scroll-" + c)) : e > 0 && u.dispatchEvent(v("ps-scroll-" + h)), i && function (t, e) {
                            d(t, e), f(t, e)
                         }(t, a)), t.reach[a] && (e || n) && u.dispatchEvent(v("ps-" + a + "-reach-" + t.reach[a]))
                      }(t, r, l, i, n)
                   }
                   ...
                   function X(t) {
                      ...
                      t.containerWidth = Math.round(n.width), t.containerHeight = Math.round(n.height), t.contentWidth = r.scrollWidth, t.contentHeight = r.scrollHeight, r.contains(t.scrollbarXRail) || (o(r, c.rail("x")).forEach((function (t) {
                            return l(t)
                         })), r.appendChild(t.scrollbarXRail)), r.contains(t.scrollbarYRail) || (o(r, c.rail("y")).forEach((function (t) {
                            return l(t)
                         })), r.appendChild(t.scrollbarYRail)), !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth ? (t.scrollbarXActive = !0, t.railXWidth = t.containerWidth - t.railXMarginWidth, t.railXRatio = t.containerWidth / t.railXWidth, t.scrollbarXWidth = w(t, Y(t.railXWidth * t.containerWidth / t.contentWidth)), t.scrollbarXLeft = Y((t.negativeScrollAdjustment + r.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1, !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight ? (t.scrollbarYActive = !0, t.railYHeight = t.containerHeight - t.railYMarginHeight, t.railYRatio = t.containerHeight / t.railYHeight, t.scrollbarYHeight = w(t, Y(t.railYHeight * t.containerHeight / t.contentHeight)), t.scrollbarYTop = Y(i * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1, t.scrollbarXLeft >= t.railXWidth - t.scrollbarXWidth && (t.scrollbarXLeft = t.railXWidth - t.scrollbarXWidth), t.scrollbarYTop >= t.railYHeight - t.scrollbarYHeight && (t.scrollbarYTop = t.railYHeight - t.scrollbarYHeight),
                         function (t, r) {
                            var i = {
                                  width: r.railXWidth
                               },
                   ...
                   function W(t, e) {
                      ...
                      function m(e) {
                         e.touches && e.touches[0] && (e[n] = e.touches[0].pageY), p[a] = b + v * (e[n] - g), d(t, c), X(t), e.stopPropagation(), e.type.startsWith("touch") && e.changedTouches.length > 1 && e.preventDefault()
                      }
 
                      function Y() {
                         f(t, c), t[u].classList.remove(h.clicking), t.event.unbind(t.ownerDocument, "mousemove", m)
                      }
 
                      function y(e, o) {
                         b = p[a], o && e.touches && (e[n] = e.touches[0].pageY), g = e[n], v = (t[i] - t[r]) / (t[l] - t[s]), o ? t.event.bind(t.ownerDocument, "touchmove", m) : (t.event.bind(t.ownerDocument, "mousemove", m), t.event.once(t.ownerDocument, "mouseup", Y), e.preventDefault()), t[u].classList.add(h.clicking), e.stopPropagation()
                      }
                   ...
                   var L = {
                         ...
                         keyboard: function (t) {
                            ...
                            t.event.bind(t.ownerDocument, "keydown", (function (r) {
                               if (!(r.isDefaultPrevented && r.isDefaultPrevented() || r.defaultPrevented) && (n(e, ":hover") || n(t.scrollbarX, ":focus") || n(t.scrollbarY, ":focus"))) {
                                  ...
                                  t.settings.suppressScrollX && 0 !== l || t.settings.suppressScrollY && 0 !== o || (e.scrollTop -= o, e.scrollLeft += l, X(t), function (r, i) {
                         ...
                         wheel: function (e) {
                            ...
                            function i(i) {
                               var n = function (t) {
                                  ...
                                  o = n[1];
                               if (! function (e, i, n) {
                                     if (!y.isWebKit && r.querySelector("select:focus")) return !0;
                                     ...
                                     for (var l = e; l && l !== r;) {
                                        ...
                                        if (n && o.overflowY.match(/(scroll|auto)/)) {
                                           ...
                                           if (s > 0 && (l.scrollTop > 0 && n < 0 || l.scrollTop < s && n > 0)) return !0
                                        }
                         ...
                         touch: function (e) {
                            if (y.supportsTouch || y.supportsIePointer) {
                               var r = e.element,
                                  ...
                                  l = {},
                                  o = null;
                               y.supportsTouch ? (e.event.bind(r, "touchstart", u), e.event.bind(r, "touchmove", d), e.event.bind(r, "touchend", f)) : y.supportsIePointer && (window.PointerEvent ? (e.event.bind(r, "pointerdown", u), e.event.bind(r, "pointermove", d), e.event.bind(r, "pointerup", f)) : window.MSPointerEvent && (e.event.bind(r, "MSPointerDown", u), e.event.bind(r, "MSPointerMove", d), e.event.bind(r, "MSPointerUp", f)))
                            }
                                  ...
                                  g > 0 && (l.x = f / g, l.y = p / g, n = b),
                                     function (t, i) {
                                        var n = Math.floor(r.scrollTop),
                                           ...
                                           s = Math.abs(i);
                                        if (s > o) {
                                           if (i < 0 && n === e.contentHeight - e.containerHeight || i > 0 && 0 === n) return 0 === window.scrollY && i > 0 && y.isChrome
                            ...
                            function f() {
                               e.settings.swipeEasing && (clearInterval(o), o = setInterval((function () {
                                  e.isInitialized ? clearInterval(o) : l.x || l.y ? Math.abs(l.x) < .01 && Math.abs(l.y) < .01 ? clearInterval(o) : e.element ? (s(30 * l.x, 30 * l.y), l.x *= .8, l.y *= .8) : clearInterval(o) : clearInterval(o)
                               }), 10))
                            }
                         }
                      },
                      R = function (i, n) {
                         ...
                         for (var o in this.element = i, i.classList.add(s), this.settings = {
                         ...
                         this.isRtl = "rtl" === t(i).direction, !0 === this.isRtl && i.classList.add(a), this.isNegativeScroll = (u = i.scrollLeft, null, i.scrollLeft = -1, d = i.scrollLeft < 0, i.scrollLeft = u, d), this.negativeScrollAdjustment = this.isNegativeScroll ? i.scrollWidth - i.clientWidth : 0, this.event = new g, this.ownerDocument = i.ownerDocument || document, this.scrollbarXRail = r(c.rail("x")), i.appendChild(this.scrollbarXRail), this.scrollbarX = r(c.thumb("x")), this.scrollbarXRail.appendChild(this.scrollbarX), this.scrollbarX.setAttribute("tabindex", 0), this.event.bind(this.scrollbarX, "focus", f), this.event.bind(this.scrollbarX, "blur", p), this.scrollbarXActive = null, this.scrollbarXWidth = null, this.scrollbarXLeft = null;
                         var b = t(this.scrollbarXRail);
                         this.scrollbarXBottom = parseInt(b.bottom, 10), isNaN(this.scrollbarXBottom) ? (this.isScrollbarXUsingBottom = !1, this.scrollbarXTop = Y(b.top)) : this.isScrollbarXUsingBottom = !0, this.railBorderXWidth = Y(b.borderLeftWidth) + Y(b.borderRightWidth), e(this.scrollbarXRail, {
                            display: "block"
                         }), this.railXMarginWidth = Y(b.marginLeft) + Y(b.marginRight), e(this.scrollbarXRail, {
                            display: ""
                         }), this.railXWidth = null, this.railXRatio = null, this.scrollbarYRail = r(c.rail("y")), i.appendChild(this.scrollbarYRail), this.scrollbarY = r(c.thumb("y")), this.scrollbarYRail.appendChild(this.scrollbarY), this.scrollbarY.setAttribute("tabindex", 0), this.event.bind(this.scrollbarY, "focus", f), this.event.bind(this.scrollbarY, "blur", p), this.scrollbarYActive = null, this.scrollbarYHeight = null, this.scrollbarYTop = null;
                         var v = t(this.scrollbarYRail);
                         this.scrollbarYRight = parseInt(v.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = Y(v.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ? function (e) {
                            var r = t(e);
                            return Y(r.width) + Y(r.paddingLeft) + Y(r.paddingRight) + Y(r.borderLeftWidth) + Y(r.borderRightWidth)
                         }(this.scrollbarY) : null, this.railBorderYWidth = Y(v.borderTopWidth) + Y(v.borderBottomWidth), e(this.scrollbarYRail, {
                            display: "block"
                         }), this.railYMarginHeight = Y(v.marginTop) + Y(v.marginBottom), e(this.scrollbarYRail, {
                            display: ""
                   ...
                   return R.prototype.update = function () {
                      this.isAlive && (this.negativeScrollAdjustment = this.isNegativeScroll ? this.element.scrollWidth - this.element.clientWidth : 0, e(this.scrollbarXRail, {
                         ...
                         display: "block"
                      }), this.railXMarginWidth = Y(t(this.scrollbarXRail).marginLeft) + Y(t(this.scrollbarXRail).marginRight), this.railYMarginHeight = Y(t(this.scrollbarYRail).marginTop) + Y(t(this.scrollbarYRail).marginBottom), e(this.scrollbarXRail, {
                         display: "none"
                      }), e(this.scrollbarYRail, {
                         display: "none"
                      }), X(this), m(this, "top", 0, !1, !0), m(this, "left", 0, !1, !0), e(this.scrollbarXRail, {
                         display: ""
                      }), e(this.scrollbarYRail, {
                         display: ""
                      }))
                   }, R.prototype.onScroll = function (t) {
                      this.isAlive && (X(this), m(this, "top", this.element.scrollTop - this.lastScrollTop), m(this, "left", this.element.scrollLeft - this.lastScrollLeft), this.lastScrollTop = Math.floor(this.element.scrollTop), this.lastScrollLeft = this.element.scrollLeft)
